...
exports.createProduct = async (productName,price,description,category,stock,images) =>{
    return await Product.create({productName,price,description,category,stock,images});
}
